...
/**
 * i kann mit Progress ersetzt werden
 * lastUpdate mit der Klassenvariable last Update
 * falls es mehr als 10 funktionen sind, ansonsten is static ok speichertechnisch vernachlässigbar
 */
